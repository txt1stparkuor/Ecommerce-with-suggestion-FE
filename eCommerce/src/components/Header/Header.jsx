...
const Header = () => {
  ...
  return (
    <header className="bg-gradient-to-b from-[#f53d2d] to-[#f63] py-2 md:py-4">
      <div className="container mx-auto flex items-center justify-between px-4">
        <Link to="/" className="flex items-center gap-1 md:gap-2 text-white no-underline hover:text-white">
          <ShoppingOutlined className="text-2xl md:text-4xl" />
          <span className="hidden md:block text-xl md:text-3xl font-bold">Shopping</span>
        </Link>
